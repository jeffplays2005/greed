 ...
 */
export function getUser(options: GetUserOptions<true>): User | undefined
export function getUser(options: GetUserOptions<false>): User
export function getUser({
  message,
  bot,
  toFind = "",
  excludeSelf,
}: GetUserOptions<boolean>): User | undefined {
